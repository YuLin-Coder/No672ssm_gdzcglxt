...
public class Scarp {
	...
	public String toString() {
		return "Scarp [scarpid=" + this.scarpid + ", deptid=" + this.deptid + ", equipmentid=" + this.equipmentid + ", reason=" + this.reason
				+ ", employid=" + this.employid + ", addtime=" + this.addtime + ", memo=" + this.memo + ", deptname=" + this.deptname
				+ ", equipmentname=" + this.equipmentname + ", employname=" + this.employname + "]";
	}
