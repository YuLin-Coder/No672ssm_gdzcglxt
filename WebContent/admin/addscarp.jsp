...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>新增资产报废信息</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="scarp/addScarp.action" name="myform">
				...
				<div class="form-group">
					...
					<div class="field">
						<select name="equipmentid" class="input w150" id="equipmentid"><option value="">---请选择资产--</option>
