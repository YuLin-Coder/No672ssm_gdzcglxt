...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>新增盘盈信息</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="pwin/addPwin.action" name="myform">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="wno" class="input w150" id="wno" placeholder="请输入单号" value="${wno }" readonly="readonly"/>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
