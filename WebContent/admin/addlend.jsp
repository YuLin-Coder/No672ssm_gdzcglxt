...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>新增设备借用信息</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="lend/addLend.action" name="myform">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="lno" class="input w150" id="lno" placeholder="请输入借用单号" value="${lno }" readonly="readonly" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="reason" class="input w150" id="reason" placeholder="请输入借用原因" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
