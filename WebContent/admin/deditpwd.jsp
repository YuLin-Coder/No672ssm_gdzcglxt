...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="employ/editpwd.action">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input w150" id="newpassword" name="newpassword" placeholder="请输入新密码"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input w150" id="repassword" name="repassword" placeholder="请再次输入新密码"
