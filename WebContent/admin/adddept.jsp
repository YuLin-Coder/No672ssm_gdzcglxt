...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>新增部门信息</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="dept/addDept.action" name="myform">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="deptname" class="input w150" id="deptname" placeholder="请输入部门名称" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" name="manager" class="input w150" id="manager" placeholder="请输入负责人" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
