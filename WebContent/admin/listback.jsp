		...
		<table class="table table-hover text-center">
			...
			<c:forEach items="${backList}" var="back">
				<tr>
					...
					<td>${back.addtime}</td>
					<td>${back.memo}</td>
					<td><a href="back/getBackById.action?id=${back.backid}"><span class="icon-edit"></span>编辑</a>&nbsp;&nbsp;<a
						href="back/deleteBack.action?id=${back.backid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}"><span
