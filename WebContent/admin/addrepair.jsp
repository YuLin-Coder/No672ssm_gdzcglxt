...
<body>
	<div class="panel admin-panel" style="width: 75%; margin: 0 auto;">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>新增资产维修信息</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="repair/addRepair.action" name="myform">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="cost" class="input w150" id="cost" placeholder="请输入花费金额" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
